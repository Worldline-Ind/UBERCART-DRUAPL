...
class WorldlineController extends ControllerBase
{
    public function worldlineRequest()
    {
        ...
        if (!$post_params["payment_order_mode_raw"] || $post_params["payment_order_mode_raw"] == "all") {
        ...
        $newPaymentOrder = rtrim($newPaymentOrder, ",");
        $newPaymentOrder .= "]";
            ...
            function handleResponse(res) {
                ...
                var configJson = {
                    ...
                    'features': {
                        ...
                        'enableExpressPay': " . $post_params['enableExpressPay'] . ",
                        'enableNewWindowFlow': true,
                        'separateCardMode': " . $post_params['separateCardMode'] . ",
                        'enableMerTxnDetails': " . $post_params['enableMerTxnDetails'] . ",
                        'enableInstrumentDeRegistration':" . $post_params['enableInstrumentDeRegistration'] . ",
                        'hideSavedInstruments' : " . $post_params['hideSavedInstruments'] . ",
                    },
                    'consumerData': {
